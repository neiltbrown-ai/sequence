...
- CRITICAL: The member's industry is in the "discipline" field (one of 16 canonical slugs: visual_art, design, photography, comics, architecture, fashion, film_tv, music, theater, comedy, writing, media, advertising, hospitality, technology, gaming) and their specializations are in the "sub_discipline" field (an array of up to 3 sub-discipline slugs). Use these EXACT values to describe the member. For example, if discipline is "design" and sub_discipline is ["brand_identity", "product_ux"], describe them as a brand identity + product/UX designer — NOT a painter, visual artist, or any other discipline. Never infer or guess their discipline from creative_mode alone.
