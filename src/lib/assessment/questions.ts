...
const Q_IND_PHOTO_1: AssessmentQuestion = {
  ...
  questionText: 'Who owns the rights to the photographs you create? (select up to 3)',
  answerType: 'multi_select',
  maxSelections: 3,
  options: [
...
const Q_IND_PHOTO_2: AssessmentQuestion = {
  ...
  section: 'deep_dive',
  pool: 'industry_photography',
  questionText: 'How is your photography work typically compensated? (select up to 3)',
  answerType: 'multi_select',
  maxSelections: 3,
  options: [
...
const Q_IND_COMEDY_1: AssessmentQuestion = {
  ...
  questionText: 'How do you primarily monetize your comedy work? (select up to 3)',
  answerType: 'multi_select',
  maxSelections: 3,
  options: [
...
const Q_IND_MEDIA_1: AssessmentQuestion = {
  ...
  section: 'deep_dive',
  pool: 'industry_media',
  questionText: 'How is your media work structured for revenue? (select up to 3)',
  answerType: 'multi_select',
  maxSelections: 3,
  options: [
...
const Q_IND_HOSP_2: AssessmentQuestion = {
  ...
  section: 'deep_dive',
  pool: 'industry_hospitality',
  questionText: 'How do you participate in upside beyond your operating role? (select up to 3)',
  answerType: 'multi_select',
  maxSelections: 3,
  options: [
...
const Q_IND_GAMING_2: AssessmentQuestion = {
  ...
  section: 'deep_dive',
  pool: 'industry_gaming',
  questionText: 'How do you participate in revenue from shipped games? (select up to 3)',
  answerType: 'multi_select',
  maxSelections: 3,
  options: [
