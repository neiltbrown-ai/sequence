    ...
    <footer className="footer">
      <div className="footer-top">
        ...
        <div className="ft-social">
          ...
          <div className="ft-links">
            <a
              href="https://www.instagram.com/sequence.so/"
              target="_blank"
      ...
      <div className="footer-bot">
        ...
        <span><Link href="/legal" style={{ textDecoration: "none", color: "inherit", fontSize: "inherit", fontFamily: "inherit", letterSpacing: "inherit" }}>PRIVACY POLICY</Link></span>
